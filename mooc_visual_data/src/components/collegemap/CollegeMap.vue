...
<script>
  /* eslint-disable */
  import collegeData from './college_coord'
  ...
  export default {
    ...
    methods: {
      init () {
        let geoCoordMap = collegeData
        let data = courseData.getCourse(this.$route.params.courseId).collegeUser
          ...
          series: [
            {
              ...
              symbolSize: function (val) {
                return Math.max(Math.sqrt(val[2]) * 5, 8)
              },
              label: {
                normal: {
                  formatter: '{b}',
            ...
            },
            {
              ...
              symbolSize: function (val) {
                return Math.max(Math.sqrt(val[2]) * 5, 4)
              },
